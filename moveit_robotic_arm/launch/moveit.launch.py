...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .robot_description(file_path=os.path.join(get_package_share_directory("robotic_arm"), "urdf", "Robot_Arm.xacro"))
    ...
    rviz_config = os.path.join(get_package_share_directory("moveit_robotic_arm"), "config", "moveit.rviz")
